...
# BIC_rec = c(17512926, 17164477, 16888869, 16943074, 16954531, 16957232, 17059521, 17133693, 17287591)
...
BIC_plot = plot(x = 2:10, y = BIC_rec[-1], pch = 16, cex = 0.8, cex.axis = 24 / par("ps"), ylab = "BIC", ylim=c(16900000,18000000), cex.lab = 24 / par("ps"))
