...
# BIC_rec = c(696141.3, 431195.5, 443709.7, 459992.8, 472717.3, 485381.8, 514511.5, 527238.7, 539956.4)


## Save BIC plot
png(file="../figures/Figure1(c).png", width = 500, height = 400)
options(scipen = 999)
par(mar = c(4, 4.5, 2, 2), family = "Arial", font.lab = 1, font.axis = 1)  
BIC_plot = plot(x = 2:10, y = BIC_rec[-1], pch = 16, cex = 0.8, cex.axis = 24 / par("ps"), ylab = "BIC", cex.lab = 24 / par("ps"))
