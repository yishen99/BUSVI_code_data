...
t2 = Sys.time()
Running_Time_BUSVI[n_runs] = round(difftime( t2, t1, units = "secs"), 3)
...
## set the same seed as BUSVI in simulation case I
seed = 5
set.seed(seed)
...
t2 = Sys.time()
Running_Time_BUS[n_runs] = round(difftime( t2, t1, units = "secs"), 3)
...
save(Running_Time_BUSVI, file = "../result_data/Running_Time_BUSVI.RData")
save(Running_Time_BUS, file = "../result_data/Running_Time_BUS.RData")
